"""
Ollama Manager Plugin — Manage local Ollama models and agent assignments.
...
logger = logging.getLogger("OllamaPlugin")
...
class OllamaPlugin(Plugin):
    ...
    def get_commands(self):
        from tubecli.plugins.ollama_manager.commands import ollama_group
        return ollama_group

    def get_routes(self):
        from tubecli.plugins.ollama_manager.routes import router
        return router
