"""
Ollama Manager Plugin — CLI commands.
"""
import click
...
def ollama_status():
    ...
    from tubecli.plugins.ollama_manager.plugin import ollama_model_manager
...
def list_models():
    ...
    if not models:
        console.print("[dim]No models installed. Use: tubecli ollama pull <model>[/dim]")
        return
...
def pull_model(model_name):
    ...
    Example: tubecli ollama pull qwen:latest
    """
    from tubecli.plugins.ollama_manager.plugin import ollama_model_manager
