"""
Cloud API Plugin — Manages cloud AI providers and API keys.
...
logger = logging.getLogger("CloudApiPlugin")
...
class CloudApiPlugin(Plugin):
    ...
    def get_commands(self):
        from tubecli.plugins.cloud_api.commands import cloud_api_group
        return cloud_api_group

    def get_routes(self):
        from tubecli.plugins.cloud_api.routes import router
        return router
