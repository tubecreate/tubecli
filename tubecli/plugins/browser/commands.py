...
def list_profiles():
    ...
    from tubecli.plugins.browser.profile_manager import list_profiles as _list
    profiles = _list()
...
def create_profile(name, proxy, tags):
    ...
    from tubecli.plugins.browser.profile_manager import create_profile as _create
    try:
...
def delete_profile(name):
    ...
    from tubecli.plugins.browser.profile_manager import delete_profile as _delete
    if _delete(name):
