...
async def api_update_profile(name: str, req: ProfileUpdateRequest):
    from tubecli.extensions.browser.profile_manager import update_profile
...
async def api_get_fingerprint(name: str):
    from tubecli.extensions.browser.profile_manager import get_fingerprint
...
async def api_reset_fingerprint(name: str):
    from tubecli.extensions.browser.profile_manager import reset_fingerprint
