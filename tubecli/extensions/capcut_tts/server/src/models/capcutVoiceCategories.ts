 ...
 */
export const capCutCategoryLanguages: Record<string, string> = {
  english: 'en',
  japanese: 'ja',
  riyu: 'ja',
  korean: 'ko',
 ...
 */
export const capCutTagLanguages: Record<string, string> = {
  英语: 'en',
  美式口音: 'en',
  英式口音: 'en',
  english: 'en',
 ...
 * 国名で絞り込みたいとき用の補助
 */
export const capCutLanguageCountries: Record<string, string[]> = {
  en: ['us', 'gb', 'au'],
  ja: ['jp'],
  ko: ['kr'],
  zh: ['cn', 'tw'],
 ...
 * 国コードから言語コードを引く逆引き表
 */
export const capCutCountryLanguages: Record<string, string> = Object.entries(
  capCutLanguageCountries
).reduce<Record<string, string>>((acc, [language, countries]) => {
