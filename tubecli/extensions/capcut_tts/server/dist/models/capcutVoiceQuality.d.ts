...
export declare const brokenVoiceCombos: BrokenVoiceCombo[];
/**
 * カタログから除外すべき話者かを判定する
 */
export declare const isBrokenVoice: (language: string | undefined, platform: string | undefined) => BrokenVoiceCombo | undefined;
