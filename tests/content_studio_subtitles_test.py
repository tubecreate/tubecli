...
check("J apiFetch parse sẵn", "const data = await apiFetch('/subtitle-styles')" in js and ".json()" not in js.split("async function loadSubtitleStyles")[1].split("function renderSubtitlePreview")[0])
