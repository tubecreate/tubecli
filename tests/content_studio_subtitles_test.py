...
check("J cache-bust", "studio2.js?v=20260907_lang" in html)
check("J Language trên Voice", html.index('id="wizLanguage"') < html.index('id="wizSubtitleStyle"') < html.index('id="wizTtsPreset"'))
check("J lọc giọng CapCut theo ngôn ngữ", "startsWith(langKey)" in js)
